...
namespace FT_EClaim.Module.BusinessObjects
{
    ...
    [Appearance("ClaimTrxAttachments1", AppearanceItemType = "Action", TargetItems = "Link", Context = "ListView", Visibility = DevExpress.ExpressApp.Editors.ViewItemVisibility.Hide)]
    [Appearance("ClaimTrxAttachments2", AppearanceItemType = "Action", TargetItems = "Unlink", Context = "ListView", Visibility = DevExpress.ExpressApp.Editors.ViewItemVisibility.Hide)]
    [XafDisplayName("Attachment")]
    // Specify more UI options using a declarative approach (https://documentation.devexpress.com/#eXpressAppFramework/CustomDocument112701).
    public class ClaimTrxAttachments : FileAttachmentBase
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        public ClaimTrxAttachments(Session session)
            : base(session)
        {
        }
        ...
        [Association("ClaimTrxs-ClaimTrxAttachments")]
        ...
        private ClaimTrxDetails _ClaimTrxDetails;
        [Association("ClaimTrxDetails-ClaimTrxAttachments")]
        [Index(99), VisibleInListView(false), VisibleInDetailView(true), VisibleInLookupListView(false)]
        [Appearance("ClaimTrxDetails", Enabled = false)]
        public ClaimTrxDetails ClaimTrxDetails
        {
            get { return _ClaimTrxDetails; }
            set { SetPropertyValue("ClaimTrxDetails", ref _ClaimTrxDetails, value); }
        }
        ...
        {
            ClaimTrx = Session.GetObjectByKey<ClaimTrxs>(ClaimTrxDetails.ClaimTrx.Oid);
            base.OnSaved();
        }
    }
}