...
namespace FT_EClaim.Module.BusinessObjects
{
    ...
    [RuleCriteria("PositionsDeleteRule", DefaultContexts.Delete, "1=0", "Cannot Delete.")]
    // Specify more UI options using a declarative approach (https://documentation.devexpress.com/#eXpressAppFramework/CustomDocument112701).
    public class Positions : XPObject
    { // Inherit from a different class to provide a custom primary key, concurrency and deletion behavior, etc. (https://documentation.devexpress.com/eXpressAppFramework/CustomDocument113146.aspx).
        public Positions(Session session)
            : base(session)
        {
        }
        ...
        [Appearance("Employee", Enabled = false)]
        ...
        [XafDisplayName("Trigger Position")]
        public XPCollection<Approvals> TriggerApprovalPosition
        {
            get { return GetCollection<Approvals>("TriggerApprovalPosition"); }
        }
        [Browsable(false)]
        [Association("ApprovalUserPositions")]
        [XafDisplayName("Approve Position")]
        public XPCollection<Approvals> UserApprovalPosition
        {
            get { return GetCollection<Approvals>("UserApprovalPosition"); }
        }
        [Browsable(false)]
