...
namespace FT_EClaim.Module.BusinessObjects
{
    ...
    //[Appearance("HideNewInLookup", AppearanceItemType = "Action", TargetItems = "New", Visibility = ViewItemVisibility.Hide, Context = "Divisions_LookupListView")]
    [RuleCriteria("DivisionsDeleteRule", DefaultContexts.Delete, "1=0", "Cannot Delete.")]
