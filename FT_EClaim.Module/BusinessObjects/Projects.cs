...
namespace FT_EClaim.Module.BusinessObjects
{
    ...
    //[Appearance("HideNewInLookup", AppearanceItemType = "Action", TargetItems = "New", Visibility = ViewItemVisibility.Hide, Context = "Projects_LookupListView")]
    [RuleCriteria("ProjectsDeleteRule", DefaultContexts.Delete, "1=0", "Cannot Delete.")]
