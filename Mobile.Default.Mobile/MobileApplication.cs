...
namespace Mobile.Default.Mobile {
    ...
    public partial class DefaultMobileApplication : MobileApplication {
        ...
        private Mobile.Default.Module.Mobile.DefaultMobileModule module4;
        ...
        static DefaultMobileApplication() {
        ...
        #endregion
        public DefaultMobileApplication() {
        ...
        private void DefaultMobileApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
