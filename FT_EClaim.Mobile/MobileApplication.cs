...
namespace FT_EClaim.Mobile {
    ...
    public partial class FT_EClaimMobileApplication : MobileApplication {
        ...
        private FT_EClaim.Module.Mobile.FT_EClaimMobileModule module4;
        ...
        static FT_EClaimMobileApplication() {
        ...
        #endregion
        public FT_EClaimMobileApplication() {
        ...
        protected override void SetLogonParametersForUIBuilder(object logonParameters) {
            ...
            ((AuthenticationStandardLogonParameters)logonParameters).Password = "super";
        }
        ...
        private void FT_EClaimMobileApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
